    ...
    return (
        <div className="flex h-screen bg-[#0B0F1E] noise-bg text-slate-200 overflow-hidden font-sans">
            ...
            <aside className={cn(
                ...
                {/* Brand */}
                <div className="h-24 flex items-center px-4 shrink-0 cursor-pointer" onClick={() => navigate('/')} data-tour="header-logo">
                    <img
                        ...
                        className={cn(
                            ...
                            isSidebarOpen ? "h-20 w-auto max-w-[200px]" : "h-12 w-auto mx-auto"
                        )}
                    />
                </div>
                            ...
                            <div className="px-6 py-4 border-b border-white/5 bg-slate-950/20 space-y-3">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-3 cursor-pointer" onClick={() => { navigate('/'); setIsMobileMenuOpen(false); }}>
                                        <img src="/assets/logo-horizontal.png" alt="Star Ranker" className="h-14 w-auto max-w-[180px] object-contain drop-shadow-[0_0_15px_rgba(245,158,11,0.25)]" />
                                    </div>
