...
export function MainLayout() {
    ...
    return (
        <div className="flex h-screen bg-brand-bg text-slate-200 overflow-hidden font-sans">
            {/* Desktop Sidebar */}
            <aside className={cn(
                "hidden md:flex flex-col bg-brand-surface border-r border-brand-border transition-all duration-300 relative z-50",
            ...
            <main className="flex-1 flex flex-col min-w-0 overflow-hidden relative">
                {/* Top Navigation Bar */}
                <header className="h-16 border-b border-brand-border bg-brand-bg/80 backdrop-blur-md flex items-center justify-between px-6 shrink-0 z-40">
                        ...
                        {!user ? (
                            ...
                            <div className="flex items-center gap-3 relative">
                                <div className="text-right hidden sm:block">
                                    ...
                                    <div className="text-[10px] font-mono text-emerald-500 font-bold">${balance.toLocaleString()}</div>
                                </div>
                                <button
